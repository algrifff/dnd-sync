...
export default function AdminLoginPage(): React.JSX.Element {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F4EDE0] p-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex items-center gap-2">
          <Shield size={18} className="text-[#5A4F42]" aria-hidden />
          <h1
            className="text-xl font-bold text-[#2A241E]"
